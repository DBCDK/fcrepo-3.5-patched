...
public class FieldSearchServlet
    ...
    private String[] getFieldsArray(HttpServletRequest req) {
        ...
        if (req.getParameter("relSysPredObj") != null
                && req.getParameter("relSysPredObj").equalsIgnoreCase("true")) {
            l.add("relSysPredObj");
        }
    ...
    private void printObjectFieldsToXml(
        ...
        appendXML("relObj", objFields.relObjs(), xmlBuf);
        appendXML("relPredObj", objFields.relPredObjs(), xmlBuf);
        appendXML("relSysPredObj", objFields.relSysPredObjs(), xmlBuf);
    ...
    private void printSearchFormToHtml(Set<String> fieldHash, String terms, String query, PrintWriter html) {
        ...
        html.append("<input type=\"checkbox\" name=\"relPredObj\" value=\"true\""
        ...
        html.append("<input type=\"checkbox\" name=\"relSysPredObj\" value=\"true\""
                        + (fieldHash.contains("relSysPredObj") ? " checked"
                                : "")
                        + "> <a href=\"#\" onClick=\"javascript:alert('Predicate and relation for RELS-SYS')\">relSysPredObj</a><br>");
    ...
    private void printHiddenFieldsFormToHtml(FieldSearchResult fsr, 
        ...
        if (fsr != null && fsr.getToken() != null) {
            ...
            if (fieldHash.contains("relSysPredObj")) {
                html
                        .append("<input type=\"hidden\" name=\"relSysPredObj\" value=\"true\">");
            }
