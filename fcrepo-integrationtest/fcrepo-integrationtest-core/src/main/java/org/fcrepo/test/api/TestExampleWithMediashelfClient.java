...
public class TestExampleWithMediashelfClient extends FedoraServerTestCase {
	...
	public void setUp() throws Exception {
        client = new com.yourmediashelf.fedora.client.FedoraClient(
                new com.yourmediashelf.fedora.client.FedoraCredentials(getBaseURL(),
	...
	public void testObjectHistory() throws Exception {
		com.yourmediashelf.fedora.client.response.GetObjectHistoryResponse response = com.yourmediashelf.fedora.client.FedoraClient.getObjectHistory(
